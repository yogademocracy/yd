...
module.exports.render = function (context, modelIn) {
    ...
    var params = {};
    try {
        params = JSON.parse(context.renderParameters);
    } catch (error) {
        /* empty */
    }

    model.action = params.action ? params.action : '';
    model.queryString = params.queryString ? params.queryString : '';
    model.locale = params.locale ? params.locale : '';
